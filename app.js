...
function updateSkin(ratio){
  ...
  if(ratio < 0.3){
    document.body.classList.add("skin-normal");
  }else if(ratio < 0.7){
    document.body.classList.add("skin-jungle");
  }else{
    document.body.classList.add("skin-volcano");
  }
}
...
els.showTableBtn.onclick=()=>{
  buildKukuGrid(); els.tableModal.classList.remove("hidden");
};
